...
pub struct BusRequest {
    channel: Channel<N64Actors, BusActor, BusAccept>,
    piority: u16,
    count: u16,
}
...
impl BusRequest {
    ...
    pub fn new<Requestor>(count: u16) -> Self
    where
    Requestor: Handler<N64Actors, BusAccept> + Actor<N64Actors>
    {
        Self {
            channel: Channel::new::<Requestor>(),
